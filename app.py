...
# Function to plot the original and segmented images side by side
def plot_segmented_image(original_img, segmented_img, num_clusters):
    ...
    # Add cluster labels to the segmented image
...
# Function to process the image using K-means clustering
def process_image(img, max_clusters):
    ...
    for num_clusters in range(2, max_clusters + 1):
        ...
        # Keep track of the best segmentation
        if score > best_score:
            best_score = score
...
if uploaded_files:
    if st.sidebar.button("Run K-means Clustering", key="run_button"):
        for idx, uploaded_file in enumerate(uploaded_files):
            ...
            # Display original and best segmented image
            ...
            # Display all segmentation results in an expander
